  ...
  const getTransactionData = () => {
    axios
      ...
      .then((res) => {
        ...
        setToday(res.data.list2Day);
        setWeek(res.data.list2Week);
      })
      ...
      <nav>
        ...
        <div className="profile-container">
          ...
          <div className="profile-data">
            ...
            <p className="col-white50">
              {user.phoneNumber
                ? "+62 " + user.phoneNumber.slice(1, user.phoneNumber.length)
                : "Error"}
            </p>
          </div>
          ...
          <div className="profile-img">
            ...
            <div className="wrapper-notification">
              ...
              {Today && Today.length > 0 ? (
                Today.slice(0, 2).map((transaction, idx) => (
                  <li key={idx}>
                    <div className="card-notification">
                      ...
                      <div className="notif-detail">
                        <p>
                          {transactionType[transaction.transactionDetails - 1]}{" "}
                          {toFrom[transaction.transactionType]}{" "}
                          {transaction.transactionType > 0
                            ? transaction.sender
