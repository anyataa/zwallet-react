...
const About = () => {
    return (
        ...
        <div className="card-wrapper">
                <div className="card">
                    <GrPhone style={{width: '60px', height: '60px', borderRadius: '30px', background: 'rgba(71, 58, 209, 0.1)', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.05)'}}/>
                ...
                <div className="card">
                    <FiLock style={{width: '60px', height: '60px', borderRadius: '30px', background: 'rgba(71, 58, 209, 0.1)', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.05)'}}/>
                ...
                <div className="card">
                    <BsDownload style={{width: '60px', height: '60px', borderRadius: '30px', background: 'rgba(71, 58, 209, 0.1)', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.05)'}}/>
