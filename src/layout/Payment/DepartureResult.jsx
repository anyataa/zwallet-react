...
export const DepartureResult = () => {
  return (
    <div className="right">
      ...
      <Link to="/billing/transport/departresult/arrival" style={{ textDecoration: "none" }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row'}}>
          ...
          <h1 style={{marginLeft: '7vw'}}>Rp 592.500<span style={{color: 'gray', fontSize: '25px'}}>/pax</span></h1>
        </div>
          </div>
        </div>
      </Link>
      <Link to="/billing/transport/departresult/arrival" style={{ textDecoration: "none" }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row'}}>
          ...
          <h1 style={{marginLeft: '7vw'}}>Rp 1.599.100<span style={{color: 'gray', fontSize: '25px'}}>/pax</span></h1>
        </div>
          </div>
        </div>
      </Link>
      ...
      <Link to="/billing/transport/departresult/arrival" style={{ textDecoration: "none" }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row'}}>
          ...
          <h1 style={{marginLeft: '7vw'}}>Rp 642.700<span style={{color: 'gray', fontSize: '25px'}}>/pax</span></h1>
        </div>
          </div>
        </div>
      </Link>
